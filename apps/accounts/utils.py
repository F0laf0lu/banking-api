...
def generate_account_number(currency):
    ...
    currency_codes = {
        ...
        "naira": getenv("CURRENCY_CODE_NGN"),
    }
...
def calculate_luhn_check_digit(number: str):
    def split_into_digits(n: Union[str, int]):
...
def create_bank_account(user, currency, account_type):
